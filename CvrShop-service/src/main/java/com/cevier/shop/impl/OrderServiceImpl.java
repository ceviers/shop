...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderVO createOrder(SubmitOrderBO submitOrderBO) {
        ...
        UserAddress address = addressManager.queryUserAddress(userId, addressId);
...
//        newOrder.setRealPayAmount();
        ...
        for (String itemSpecId : itemSpecIdArr) {
            ...
            Items item = itemManager.getById(itemId);
            String imgUrl = itemsImgManager.queryItemMainImgById(itemId);
            ...
            orderItemManager.save(subOrderItem);
        ...
        orderStatusManager.save(waitPayOrderStatus);
    ...
    public void updateOrderStatus(String orderId, Integer orderStatus) {
        ...
        orderStatusManager.updateById(paidStatus);
    }
